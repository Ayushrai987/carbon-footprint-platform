  ...
  return (
    <div className="min-h-screen flex items-center justify-center gradient-mesh bg-gray-50 dark:bg-dark-950 p-4">
      <div className="text-center animate-fade-in max-w-md">
        ...
        <h2 className="text-xl font-semibold text-dark-800 dark:text-dark-200 mb-3">Page Not Found</h2>
        <p className="text-dark-500 dark:text-dark-400 mb-8">The page you&apos;re looking for doesn&apos;t exist. Let&apos;s get you back on track to reducing your carbon footprint.</p>
