...
const CATEGORIES = [
  {
    id: "transportation" as EmissionCategory,
    label: "Transport",
    icon: Car,
    color: "blue",
  },
  {
    id: "energy" as EmissionCategory,
    label: "Energy",
    icon: Zap,
    color: "amber",
  },
  {
    id: "food" as EmissionCategory,
    label: "Food",
    icon: UtensilsCrossed,
    color: "emerald",
  },
  {
    id: "shopping" as EmissionCategory,
    label: "Shopping",
    icon: ShoppingBag,
    color: "purple",
  },
...
> = {
  transportation: [
    ...
    { value: "flight_international", label: "Flight (Int'l)" },
...
export default function LogActivityPage(): React.ReactElement {
  ...
  const handleSubmit = async (e: React.FormEvent): Promise<void> => {
    ...
    try {
      ...
      showToast({
        type: "success",
        message: `Logged ${record.co2Equivalent.toFixed(1)} kg CO₂ from ${activityType.replace(/_/g, " ")}`,
      });
      setSuccess(true);
      setValue("");
      setNotes("");
      ...
      showToast({
        type: "error",
        message: (err as Error).message || "Failed to log activity",
      });
    }
  };
    ...
    <div className="max-w-2xl mx-auto space-y-6">
      <div>
        ...
        <p className="text-dark-500 dark:text-dark-400 mt-1">
          Record a carbon-emitting activity
        </p>
      </div>
